               ...
               <?php
                  ...
                  the_post(); ?>
                     <div class="post-blog">
                        ...
                        <div class="post-blog__title-container">
                           <a href="<?php echo get_permalink(get_the_ID()); ?>" class="post-blog__title-link">
                              <h3 class="post-blog__title"><?php echo get_the_title(); ?></h3>
                           </a>
                        </div>
